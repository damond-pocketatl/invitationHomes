		...
		elseif (PMXI_Plugin::is_ajax()) {
			...
			foreach ($_SESSION['pmxi_import']['local_paths'] as $key => $path) {												
				...
				if ($_SESSION['pmxi_import']['options']['create_chunks'] and $_SESSION['pmxi_import']['action'] != 'continue'){
					...
					if ($_SESSION['pmxi_import']['created_records'] + $_SESSION['pmxi_import']['updated_records'] + $_SESSION['pmxi_import']['skipped_records'] + $_SESSION['pmxi_import']['errors'] == $_SESSION['pmxi_import']['count']) break;
				    ...
				    while ($xml = $file->read()) {
					    ...
					    if (($_SESSION['pmxi_import']['created_records'] + $_SESSION['pmxi_import']['updated_records'] + $_SESSION['pmxi_import']['skipped_records'] + $_SESSION['pmxi_import']['errors'] == $_SESSION['pmxi_import']['count']) and !in_array($import->type, array('ftp'))){
